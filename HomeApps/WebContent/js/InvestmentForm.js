function InvestmentForm(id, callbackObjs, appData) {
...
InvestmentForm.prototype = new WuiComponent;

InvestmentForm.prototype.getFieldSettings = function() {
	var appData = this.appData;
	
	function autoComplete(evt) {
		var htmlElement = evt.currentTarget;
		var subcatgList = appData.getTranxSubcatgList('Investments');
		var input;
...
InvestmentForm.prototype.getElementDef = function() {
	...
	var initElements = {tag:'div',className:'investmentForm',attr:{state:'hide',subcatgMode:'type'},elements:wui.toElements(
...
InvestmentForm.prototype.show = function() {
...
InvestmentForm.prototype.hide = function() {
	this.htmlElement.setAttribute('state','hide');
	this.htmlElement.className = this.htmlElement.className;
};

InvestmentForm.prototype.edit = function(record, token) {
	this.record = record;
	this.token = token;
...
InvestmentForm.prototype.updateData = function(w3cEvent) {
	this.hide();
...
InvestmentForm.prototype.cancel = function(w3cEvent) {
	this.hide();
...
InvestmentForm.prototype.cbSwitchToType = function(w3cEvent) {
	this.htmlElement.setAttribute('subcatgMode','type');
	this.htmlElement.className = this.htmlElement.className;
};

InvestmentForm.prototype.cbSwitchToSelect = function(w3cEvent) {
	var textField = this.getComponent('tranxSubcatg');
	var dropdownField = this.getComponent('tranxSubcatgDropdownField');
	var subcatgList = this.appData.getTranxSubcatgList('Investments');
...
InvestmentForm.prototype.cbSetTranxSubcatg = function(w3cEvent) {
	var textField = this.getComponent('tranxSubcatg');
	var dropdownField = this.getComponent('tranxSubcatgDropdownField');
