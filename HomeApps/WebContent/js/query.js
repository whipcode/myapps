...
function Application(htmlId) {
	...
	if (view) {
		view.add(CommandDiv, 'commandDiv');
		view.add(ResultDiv, 'resultDiv');
		view.add(PaginateDiv, 'paginateDiv');
	}
}
Application.prototype = new WuiElement();

function CommandDiv(id) {
	this.newHtmlElement(id, 'div', 'CommandDiv');
	var _this = this;
...
function ResultDiv(id) {
	this.newHtmlElement(id, 'div', 'ResultDiv');
}
ResultDiv.prototype = new WuiElement();

function PaginateDiv(id) {
	this.newHtmlElement(id, 'div', 'PaginateDiv');
}
